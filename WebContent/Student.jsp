...
<div class="form" >
<form id="category" action="AddStudent" method="post">
  <table>
	
		<tr>
			
			<td><input type="text" placeholder="Enter your RollNo"  name="rollNo"/></td>
		...
		<tr>
			...
			<td><input type="text" placeholder="Enter Your Contact No"  name="contact"/></td>
