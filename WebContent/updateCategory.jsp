...
<div class="form" >
<form id="category" action="UpdateCategory" method="post">
  <table>
  <tr>
    <td> <input type="hidden" name="id" value="<%=category.getId()%>"><td>
	
	</tr>
		<tr>
			
			<td><input type="text" name="category" value="<%=category.getCategory()%>"></td>
